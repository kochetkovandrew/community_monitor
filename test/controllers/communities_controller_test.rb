...
class CommunitiesControllerTest < ActionController::TestCase
  ...
  test "should create community" do
    assert_difference('Community.count') do
      post :create, community: { name: @community.name, screen_name: @community.screen_name, vk_id: @community.vk_id }
    end
  ...
  test "should update community" do
    patch :update, id: @community, community: { name: @community.name, screen_name: @community.screen_name, vk_id: @community.vk_id }
    assert_redirected_to community_path(assigns(:community))
  end
